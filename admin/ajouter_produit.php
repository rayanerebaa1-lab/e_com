...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO produits (nom, description, prix, image, categorie_id, stock) VALUES ('$nom', '$description', '$prix', '$image', $categorie_id, $stock)";
    if (mysqli_query($conn, $sql)) {
        header('Location: liste_produits.php?msg=added');
        exit();
    } else {
...
<body>
    <nav class="navbar navbar-dark">
        <div class="container">
            <span class="navbar-brand fw-bold">Ajouter un produit</span>
        ...
        <div class="card shadow border-0 rounded-4 p-4">
            ...
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="image" name="image" required placeholder="https://...">
                </div>
                <button type="submit" class="btn btn-primary w-100 py-2 rounded-pill"><i class="bi bi-plus-circle"></i> Ajouter</button>
            </form>
        </div>
    </div>
</body>
