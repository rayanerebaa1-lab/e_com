...
// Construction de la requête produits avec tous les filtres
$produits = [];
$params = [];
$types = "";
                ...
                <div class="filter-sidebar">
                    ...
                    <div class="mb-4">
                        ...
                        <form action="produits.php" method="get">
                            <div class="row g-2">
                                <div class="col-6">
                                    <input type="number" class="form-control" name="prix_min" placeholder="Min" min="0" step="0.01" value="<?= $prix_min !== null ? $prix_min : '' ?>">
                                </div>
                                <div class="col-6">
                                    <input type="number" class="form-control" name="prix_max" placeholder="Max" min="0" step="0.01" value="<?= $prix_max !== null ? $prix_max : '' ?>">
                                </div>
                            </div>
                            <?php if ($categorie_id > 0): ?>
                                <input type="hidden" name="categorie" value="<?= $categorie_id ?>">
